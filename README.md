...
<p align="center">
  <a href="https://devtools.at/tools/css-minifier"><img src="https://img.shields.io/badge/Try%20Online-DevTools.at-blue?style=for-the-badge" alt="Try Online"></a>
...
<p align="center">
  <a href="https://devtools.at/tools/css-minifier">Try Online</a> •
...
**[Try CSS Minifier online at DevTools.at →](https://devtools.at/tools/css-minifier)**
...
Minify CSS code. This is a standalone TypeScript/JavaScript implementation that you can use in your own projects.
...
```typescript
import { process } from '@devtools-at/css-minifier';
