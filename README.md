...
Css Minifier - Free online developer tool

## Online Tool

Use this tool online at **[DevTools.at](https://devtools.at/tools/css-minifier)** - Free, fast, and no registration required!
...
```bash
npm install @devtools-at/css-minifier
```

### Usage

```javascript
import { process, encode, decode } from '@devtools-at/css-minifier';
...
**[https://devtools.at/tools/css-minifier](https://devtools.at/tools/css-minifier)**
...
- [npm Package](https://www.npmjs.com/package/@devtools-at/css-minifier)
